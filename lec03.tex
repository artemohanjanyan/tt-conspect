\subsection*{\texorpdfstring{Просто типизированное $\lambda$-исчисление}{Simply typed lambda calculus}}
...
\]
Рассмотрим такой тип на Haskell: \mintinline{Haskell}{data Fruit = Orange Int | Banana Int}. Левая инъекция для него "---
