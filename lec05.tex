...
%\[
%    \infer{\vdash \Lambda \beta . \lambda a^{\forall \alpha . \alpha} . a ((\forall \alpha.\alpha) \rightarrow \beta) a :
%            \forall \beta . (\forall \alpha.\alpha) \rightarrow \beta}
%    {   \infer{\vdash \lambda a^{\forall \alpha . \alpha} . a ((\forall \alpha.\alpha) \rightarrow \beta) a :
%                (\forall \alpha.\alpha) \rightarrow \beta}
%        {   \infer{a : \forall \alpha . \alpha \vdash a ((\forall \alpha.\alpha) \rightarrow \beta) a : \beta}
%            {   \infer{a : \forall \alpha . \alpha \vdash a ((\forall \alpha.\alpha) \rightarrow \beta)
%                        : (\forall \alpha . \alpha) \rightarrow \beta}
%                {   \infer{a : \forall \alpha.\alpha \vdash a : \forall \alpha.\alpha}{}
%                }
%            &&  \infer{a : \forall \alpha . \alpha \vdash a : \forall \alpha.\alpha}{}
