...
$\forall\alpha.\alpha\rightarrow\alpha$ "--- политип, $\forall\alpha.\alpha\rightarrow\forall\beta.\beta$ "--- некорректный в Х-М тип.
...
\begin{definition}[грамматика выражения в Х-М]
\[
\begin{bnf}
...
\end{statement}
Обозначения: $\overline{\Gamma(\tau)} = \forall \alpha_1 \ldots \forall \alpha_n . \tau$,
где $\alpha_i \in \tau$ и $\alpha_i \notin \FV(\Gamma)$
...
\begin{enumerate}
    \item Если $e \equiv x$ и $x : \forall \alpha_1 \ldots \alpha_k . \tau' \in \Gamma$, то $S$
\end{enumerate}
